...
CREATE EVENT IF NOT EXISTS actualizar_dias_standby
...
BEGIN
  ...
  DECLARE cur CURSOR FOR
    SELECT Id, UltimoDiaStandBy
    FROM integraciones
    WHERE StandBy = TRUE AND Certificado = FALSE;
