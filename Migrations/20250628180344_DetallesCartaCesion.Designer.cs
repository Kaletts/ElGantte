...
namespace ElGantte.Migrations
{
    ...
    [Migration("20250628180344_DetallesCartaCesion")]
    partial class DetallesCartaCesion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElGantte.Models.Integracione", b =>
                {
                    ...
                    b.HasIndex(new[] { "CartaCesion" }, "FK_CartaCesion_idx");
            ...
            modelBuilder.Entity("ElGantte.Models.Integracione", b =>
                {
                    b.HasOne("ElGantte.Models.Cartascesion", "CartaCesionNavigation")
                        .WithMany("Integraciones")
                        .HasForeignKey("CartaCesion")
                        .HasConstraintName("FK_CartaCesion");
                    ...
                    b.Navigation("CartaCesionNavigation");
