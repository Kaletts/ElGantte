...
namespace ElGantte.Migrations
{
    ...
    [Migration("20250831185807_NuevaVariableTipoConexion")]
    partial class NuevaVariableTipoConexion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ElGantte.Models.Integracione", b =>
                {
                    ...
                    b.HasOne("ElGantte.Models.TipoConexion", "TipoConexionNavigation")
                        .WithMany("Integraciones")
                        .HasForeignKey("TipoConexion");
                    ...
                    b.Navigation("TipoConexionNavigation");
                });
